...
export async function generateMetadata(
  ...
  const { portfolioSeo, portfolio }: ModelDoc = await readClient.fetch(q, {
    slug,
  });
  ...
  return {
    ...
    openGraph: {
      images: [
        {
          url: urlFor(portfolio[0]).url(),
          width: portfolio[0].dimensions?.width,
          height: portfolio[0].dimensions?.height,
        },
      ],
      title,
      description,
